...
import static Tests.BaseTest.takeScreenshot;
...
public class MyStepdefs {
    ...
    @Then("^el elemento \"([^\"]*)\" aparece en la pagina de resultado con el precio \"([^\"]*)\"$")
    public void elElementoApareceEnLaPaginaDeResultadoConElPrecio(String nombreEsperado, String precioEsperado) throws Throwable {
